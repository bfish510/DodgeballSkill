...
public class EventDatabase {
    ...
    static {
        ...
        events.add(Event.builder()
                ...
                .timeFrameHumanReadable("10 a.m. to 3 p.m.")
                .build());
        events.add(Event.builder()
                .ballType("rubber")
                .city("Portland")
        ...
        events.add(Event.builder()
                .ballType("rubber")
                .city("Seattle")
                .date(DateTime.parse("2016-12-26"))
                .readableDate("December 26 2016")
                .recurrence("every monday")
                .where("Loyal Heights Community Center in Ballard")
                .timeFrameHumanReadable("seven to nine p.m.")
                .format("pick up")
        ...
        events.add(Event.builder()
                .ballType("foam")
                .city("Seattle")
                .date(DateTime.parse("2016-12-21"))
                .readableDate("December 21 2016")
        ...
        events.add(Event.builder()
                .ballType("foam")
                .city("Seattle")
                .date(DateTime.parse("2016-12-28"))
